    ...
    <form method="get" action="listprod.jsp" class="form-inline">
      <div class="form-group">
        <div class="col-xs-12 col-md-4">
          <label class="sr-only" for="helpProduct">Search for the products you want to buy</label>
          <input type="text" class="form-control" id="helpProduct" placeholder="Enter product name" name="productName">
        </div>
      </div>
...
try(Connection con = DriverManager.getConnection(url,uid,pw);) {
  String[] rowColours = {"","\"table-primary\"","\"table-success\"","\"table-danger\"","\"table-info\"","\"table-warning\"","\"table-light\""};
  ...
  while(rst.next()) {
    ...
    counter=i%6;
    out.println("<tr class=" + rowColours[counter] + "><td><a href=\"addcart.jsp?id=" +
    rst.getString(4) + "&name=" + rst.getString(1) +
    "&price=" + rst.getString(3) + "\">Add to Cart</a></td>" +
