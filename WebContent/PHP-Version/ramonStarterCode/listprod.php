...
<?php
	...
	while ($rst = sqlsrv_fetch_array( $pstmt, SQLSRV_FETCH_ASSOC)) {
		echo("<tr><td><a href=\"addcart.php?id=" . $rst['productId'] . "&name=" . $rst['productName'] . "&price=" . $rst['productPrice'] . "\">Add to Cart</a></td>");
		echo("<td>" . $rst['productName'] . "</td><td>$" . $rst['productPrice'] . "</td></tr>");
	}
	echo("</table>");
